	...
	*/
	...
	public :
		...
		*/
        ...
        /**
		* @brief Gets the color components of degenerated lines
		* @return the red,green,blue,alpha component of degenerated lines
		*/
		float getDegeneratedR() const;
        float getDegeneratedG() const;
        float getDegeneratedB() const;
        float getDegeneratedA() const;
    ...
    inline float GLLineTrailRenderer::getDegeneratedR() const
    {
        return degeneratedR;
    }
    inline float GLLineTrailRenderer::getDegeneratedG() const
    {
        return degeneratedG;
    }
    inline float GLLineTrailRenderer::getDegeneratedB() const
    {
        return degeneratedB;
    }
    inline float GLLineTrailRenderer::getDegeneratedA() const
    {
        return degeneratedA;
    }
